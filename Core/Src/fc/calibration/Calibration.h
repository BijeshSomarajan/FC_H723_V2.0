...
#define CALIB_PROP_ALT_HOLD_SPEED_ADDR 61
#define CALIB_PROP_VENTURI_ALT_GAIN_ADDR 65
...
#define CALIB_PROP_ALT_HOLD_CONTROL_LIMIT_ADDR 87


#define CALIB_PROP_ALT_HOLD_ACC_PID_KD_ADDR 86 // Unused!


//Position hold process configuration
#define CALIB_PROP_POS_HOLD_PID_KP_ADDR 80
#define CALIB_PROP_POS_HOLD_PID_LIMIT_ADDR 82
#define CALIB_PROP_POS_HOLD_CRUISE_SPEED_ADDR 19 //Note the index
#define CALIB_PROP_POS_HOLD_RTH_SPEED_ADDR 85

#define CALIB_PROP_POS_HOLD_RATE_PID_KP_ADDR 83
#define CALIB_PROP_POS_HOLD_RATE_PID_KI_ADDR 81     //Note the index
...
#define CALIB_PROP_MODEL_VERSION_ADDR 63
#define CALIB_PROP_THRUST_EXPO_ADDR 18 //Note the index

#define CALIB_PROP_BAT_NOM_VOLT_ADDR 67
#define CALIB_PROP_BAT_TYPE_ADDR 89

#define CALIB_PROP_BAT_NOM_VOLT_ADDR 67
#define CALIB_PROP_BAT_TYPE_ADDR 89

#define CALIB_PROP_MAX_CONFIGURABLE_LENGTH 90
