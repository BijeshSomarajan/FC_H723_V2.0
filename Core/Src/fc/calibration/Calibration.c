...
void setDefaultCalibration() {
	...
	CALIB_DATA[CALIB_PROP_ALT_HOLD_SPEED_ADDR] = 100;
	...
	CALIB_DATA[CALIB_PROP_POS_HOLD_CRUISE_SPEED_ADDR] = 100; //1 m/sec
	...
	CALIB_DATA[CALIB_PROP_THRUST_EXPO_ADDR] = 0;

	CALIB_DATA[CALIB_PROP_POS_HOLD_RTH_SPEED_ADDR] = 25;
	CALIB_DATA[CALIB_PROP_ALT_HOLD_ACC_PID_KD_ADDR]=0;
	CALIB_DATA[CALIB_PROP_ALT_HOLD_CONTROL_LIMIT_ADDR]=500;

	CALIB_DATA[CALIB_PROP_HEADING_BIAS_ADDR] = 0.;

	CALIB_DATA[CALIB_PROP_MODEL_VERSION_ADDR] = 0;
	CALIB_DATA[CALIB_PROP_VENTURI_ALT_GAIN_ADDR] = 0;
