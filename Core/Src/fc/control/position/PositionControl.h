...
#define POSITION_CONTROL_VEL_FF_GAIN  0.025f
/*------ Disturbance Estimations -----*/
#define POSITION_CONTROL_DOB_ENABLED   1
#define POSITION_CONTROL_DOB_ACC_TAU     0.6f   // was 0.25
#define POSITION_CONTROL_DOB_VEL_TAU     1.8f   // was 1.0
#define POSITION_CONTROL_DOB_ACC_GAIN    0.05f  // was 0.10
#define POSITION_CONTROL_DOB_VEL_GAIN    0.10f  // slightly dominant
