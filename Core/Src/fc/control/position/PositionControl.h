...
/*------ FF Configurations -----*/
#define POSITION_CONTROL_VEL_FF_ENABLED 0
#define POSITION_CONTROL_VEL_FF_GAIN  0.05f//0.03f
/*------ Disturbance Estimations -----*/
#define POSITION_CONTROL_DOB_ENABLED   0
#define POSITION_CONTROL_DOB_ACC_TAU     0.12f
#define POSITION_CONTROL_DOB_VEL_TAU     0.5f
#define POSITION_CONTROL_DOB_ACC_GAIN    0.12f
#define POSITION_CONTROL_DOB_VEL_GAIN    0.20f
#define POSITION_CONTROL_DOB_ACCEL_MODEL_K 0.171f
#define POSITION_CONTROL_DOB_ACC_LIMIT    3.0f
#define POSITION_CONTROL_DOB_STATE_LIMIT  2.0f
