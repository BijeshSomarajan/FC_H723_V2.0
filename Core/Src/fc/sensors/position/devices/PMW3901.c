...
#define PMW3901_RAD_PER_COUNT 0.00168f
...
void pmwInitRegisters() {
	...
	unsigned char c2 = 0;
	pmw3901RegisterWrite(0x7F, 0x00);
	pmw3901RegisterWrite(0x55, 0x01);
	pmw3901RegisterWrite(0x50, 0x07);
	pmw3901RegisterWrite(0x7f, 0x0e);
	pmw3901RegisterWrite(0x43, 0x10);
	v = pmw3901RegisterRead(0x67);
	// if bit7 is set
	if (v & (1 << 7)) {
		pmw3901RegisterWrite(0x48, 0x04);
	} else {
		pmw3901RegisterWrite(0x48, 0x02);
	}
	pmw3901RegisterWrite(0x7F, 0x00);
	pmw3901RegisterWrite(0x51, 0x7b);
	pmw3901RegisterWrite(0x50, 0x00);
	pmw3901RegisterWrite(0x55, 0x00);
	pmw3901RegisterWrite(0x7F, 0x0e);
	v = pmw3901RegisterRead(0x73);
	if (v == 0) {
		c1 = pmw3901RegisterRead(0x70);
		if (c1 <= 28) {
			c1 = c1 + 14;
		} else {
			c1 = c1 + 11;
		...
		c2 = pmw3901RegisterRead(0x71);
		c2 = ((unsigned short) c2 * 45) / 100;
		pmw3901RegisterWrite(0x7f, 0x00);
		pmw3901RegisterWrite(0x61, 0xAD);
		pmw3901RegisterWrite(0x51, 0x70);
		pmw3901RegisterWrite(0x7f, 0x0e);
		pmw3901RegisterWrite(0x70, c1);
		pmw3901RegisterWrite(0x71, c2);
	}
	pmw3901RegisterWrite(0x7F, 0x00);
	pmw3901RegisterWrite(0x61, 0xAD);
	pmw3901RegisterWrite(0x7F, 0x03);
	...
	pmw3901RegisterWrite(0x4D, 0x11);
	pmw3901RegisterWrite(0x55, 0x80);
	pmw3901RegisterWrite(0x74, 0x21);
	pmw3901RegisterWrite(0x75, 0x1F);
	pmw3901RegisterWrite(0x4A, 0x78);
	pmw3901RegisterWrite(0x4B, 0x78);
	pmw3901RegisterWrite(0x44, 0x08);
	...
	pmw3901RegisterWrite(0x65, 0x1F);
	pmw3901RegisterWrite(0x7F, 0x14);
	pmw3901RegisterWrite(0x65, 0x67);
	pmw3901RegisterWrite(0x66, 0x08);
	pmw3901RegisterWrite(0x63, 0x70);
	pmw3901RegisterWrite(0x7F, 0x15);
	pmw3901RegisterWrite(0x48, 0x48);
	pmw3901RegisterWrite(0x7F, 0x07);
	pmw3901RegisterWrite(0x41, 0x0D);
	pmw3901RegisterWrite(0x43, 0x14);
	pmw3901RegisterWrite(0x4B, 0x0E);
...
uint8_t loadOFlowData(void) {
	if (pmw3901DataReady) {
		...
		oFlowData.qual = (float)oFlowData.qualRaw / 255.0f;
...
void __pmw3901Callback(uint8_t *rxData, uint16_t len) {
	...
	oFlowData.qualRaw = rxData[6];                                                // Reg 0x08 (Surface Quality)
