...
#define POSITION_TERRAIN_STRENGTH_MIN 0.01f
#define POSITION_TERRAIN_DIST_MIN     0.01f
#define POSITION_TERRAIN_DIST_MAX     1.5f
#define POSITION_TERRAIN_STABILITY_INVALID_GAIN    1.1f    // Decay rate multiplier for bad data
#define POSITION_TERRAIN_STABILITY_MAX_WINDOW      0.5f    // Seconds (Maximum accumulator depth)
#define POSITION_TERRAIN_TRUST_THRESHOLD 1.0f
