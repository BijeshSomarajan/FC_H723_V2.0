...
#define POS_ESTIMATOR_DYNAMIC_XY_RV_BASE         0.001f
#define POS_ESTIMATOR_DYNAMIC_XY_RV_RESET        0.5f
#define POS_ESTIMATOR_DYNAMIC_XY_RV_MAX          (POS_ESTIMATOR_DYNAMIC_XY_RV_BASE * 200.0f) // Keep it around 3


// --- EKF Pipeline Thresholds ---
#define POS_ESTIMATOR_DYNAMIC_XY_FLOW_QUAL_MIN   0.01f   // Minimum valid surface quality metric
#define POS_ESTIMATOR_DYNAMIC_XY_FLOW_HEIGHT_MIN 0.1f    // 10cm minimum height floor to prevent division by zero
#define POS_ESTIMATOR_DYNAMIC_XY_FLOW_RV_BASE    0.001f   // Base measurement variance noise
#define POS_ESTIMATOR_DYNAMIC_XY_FLOW_RV_MAX     (POS_ESTIMATOR_DYNAMIC_XY_FLOW_RV_BASE * 200.0f)
#define POS_ESTIMATOR_DYNAMIC_XY_FLOW_RV_MUTED   10000
#define POS_ESTIMATOR_DYNAMIC_XY_FLOW_PITCH_RATE_SCALE   0.85f // Pragmatic
#define POS_ESTIMATOR_DYNAMIC_XY_FLOW_ROLL_RATE_SCALE   0.85f
#define POS_ESTIMATOR_DYNAMIC_XY_FLOW_RV_LPF_ALPHA   0.10f
