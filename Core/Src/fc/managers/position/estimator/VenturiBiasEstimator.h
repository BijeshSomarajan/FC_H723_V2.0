...
#define VENTURI_EST_DRAG_GAIN                   0.32f  // High = Low terminal speed plateau | Low = High terminal speed runway
#define VENTURI_EST_BIAS_LPF_FREQ               0.25f  // High = Real-time acceleration tracking | Low = Delayed bias entry
