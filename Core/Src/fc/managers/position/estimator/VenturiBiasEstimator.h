...
#define VENTURI_EST_DRAG_GAIN                   0.85f  // High = Low terminal speed plateau | Low = High terminal speed runway
#define VENTURI_EST_BIAS_LPF_FREQ               0.10f   // High = Real-time acceleration tracking | Low = Delayed bias entry
#define VENTURI_EST_BIAS_GAIN                   6.0f  // High = Deep altitude sag at speed | Low = Ballooning upward at speed
