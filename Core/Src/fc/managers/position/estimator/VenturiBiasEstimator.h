...
#define VENTURI_EST_ACCEL_GAIN                  1.5f   // High = Faster estimated speed buildup | Low = Heavy airframe ramp compensation
#define VENTURI_EST_DRAG_GAIN                   0.34f  // High = Low terminal speed plateau | Low = High terminal speed runway
#define VENTURI_EST_BIAS_LPF_FREQ               0.1f   // High = Real-time acceleration tracking | Low = Delayed bias entry
#define VENTURI_EST_BIAS_GAIN                   0.08f  // High = Deep altitude sag at speed | Low = Ballooning upward at speed
