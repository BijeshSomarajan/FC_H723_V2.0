...
#define POSITION_MGR_POS_HOLD_BRAKE_MAX_VELOCITY             10.0f
#define POSITION_MGR_POS_HOLD_BRAKE_RATE_PI_GAIN             1.5f
#define POSITION_MGR_POS_HOLD_BRAKE_RATE_PI_GAIN_DECAY_RATE  2.0f
#define POSITION_MGR_POS_HOLD_BRAKE_REF_EST_VELOCITY_GAIN    1.3f
#define POSITION_MGR_POS_HOLD_BRAKE_REF_DRIFT_VELOCITY_GAIN  0.1f
#define POSITION_MGR_POS_HOLD_BRAKE_MAX_GROUND_SPEED         0.4f
#define POSITION_MGR_POS_HOLD_BRAKE_ACTIVE_PERIOD            0.8f
#define POSITION_MGR_POS_HOLD_BRAKE_STRENGTH                 3.0f
