...
#define POSITION_MGR_POS_HOLD_BRAKE_REF_EST_VELOCITY_GAIN    1.25f
#define POSITION_MGR_POS_HOLD_BRAKE_MAX_GROUND_SPEED         0.4f
#define POSITION_MGR_POS_HOLD_BRAKE_ACTIVE_PERIOD            0.85f
#define POSITION_MGR_POS_HOLD_BRAKE_SETTLING_PERIOD          1.0f
#define POSITION_MGR_POS_HOLD_BRAKE_STRENGTH                 1.5f
#define POSITION_MGR_POS_HOLD_SETTLE_NUDGE_GAIN     0.15f
