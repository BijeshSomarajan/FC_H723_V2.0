...
#define POSITION_MGR_MAX_POS_COMMAND  10.0f // Limit GPS tilt
...
#define POSITION_MGR_XY_POS_UPDATE_CONFIDENCE    0.04f
#define POSITION_MGR_GNSS_POS_HACC_SCALE     2.0f    // Higher scale for position
