...
#define ALTITUDE_MANAGEMENT_VEL_TASK_FREQUENCY 200
#define ALTITUDE_MANAGEMENT_VEL_TASK_PERIOD 1.0f/ALTITUDE_MANAGEMENT_VEL_TASK_FREQUENCY

#define ALTITUDE_MANAGEMENT_ALT_TASK_FREQUENCY 50
...
#define ALT_MGR_TILT_COMP_TH_ADJUST_TAU_FADE 0.08f  //Higher = slower response when tilting back to hover
#define ALT_MGR_TILT_TH_ADJUST_MAX_LIMIT   100.0f
#define ALT_MGR_TILT_COMP_TH_GAIN 2.0f
