...
#define ALTITUDE_MANAGEMENT_VEL_TASK_FREQUENCY 1000
#define ALTITUDE_MANAGEMENT_VEL_TASK_PERIOD 1.0f/ALTITUDE_MANAGEMENT_VEL_TASK_FREQUENCY

#define ALTITUDE_MANAGEMENT_ALT_TASK_FREQUENCY 200
...
#define ALT_MGR_TILT_COMP_TAU_RISE         0.05f    // Rise time constant; allows compensation to build quickly
#define ALT_MGR_TILT_COMP_TAU_FADE         0.5f    // Fade time constant; removes compensation gradually
